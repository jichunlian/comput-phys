...
subroutine rotation(rot,a,x,natom,symprec)
  ...
  integer(2) :: W11,W12,W13,W21,W22,W23,W31,W32,W33
  integer(2) :: W(3,3),rot_t(3,3,48)
  integer(2) :: i,j,k,m,n,m1,m2,n1,n2,num
  integer(2),allocatable :: rot(:,:,:)
  logical(1) :: discard
...
subroutine ibzkpt(ikpt,deg,nk,a,rot,gam,soc,symprec)
  ...
  integer(2),allocatable :: deg(:),deg_t(:),sym(:,:,:)
  integer(2) :: nk(:),km,rot(:,:,:),inv(3,3),no
  logical(1) :: gam,soc
...
program hsekpt
  ...
  integer(2) :: ng
  integer(2) :: k(3),nk,nkpts,i
  real(8) :: a(3,3)
  real(8),allocatable :: ikpt(:,:),bkpt(:,:)
  real(8),allocatable :: hkpt(:,:,:),x(:,:)
  integer(2),allocatable :: natom(:)
  integer(2),allocatable :: rot(:,:,:),deg(:)
